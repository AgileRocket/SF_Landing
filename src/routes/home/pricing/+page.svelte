    ...
    <div class="price-tags-container">
      <div class="price-tag">
        ...
        >
          ...
          <a
            type="button"
            class="contact-sales-btn mt-auto"
            href="/home/contact">contact sales</a
          >
        </div>
      </div>
      ...
      >
        ...
        <div class="flex flex-col items-center md:items-start gap-2">
          ...
          <a type="button" class="contact-sales-btn" href="/home/contact"
            >contact sales</a
          >
        </div>
      </div>
...
<style lang="postcss">
  ...
  .price-tag {
    ...
    @apply justify-around lg:justify-center;
    @apply md:items-center;
    @apply bg-primary;
    @apply py-4 ps-4 md:ps-8 lg:ps-0;
    @apply h-[17em] md:h-[15em];
    @apply w-[18em] md:w-[40em] lg:w-[50em];
    border-radius: 2em;
    clip-path: polygon(0% 0%, 85% 0%, 100% 50%, 85% 100%, 0% 100%);
    background: linear-gradient(
      to right,
      rgba(65, 97, 158, 1) 0%,
      rgba(65, 97, 158, 0.85) 25%,
      rgba(65, 97, 158, 0.62) 75%,
      rgba(65, 97, 158, 0.4) 100%
    );
  }
  ...
  .checkmark {
    display: block;
    background: url("/src/lib/assets/icons/checkmark.png");
  ...
  :global(tr) {
    @apply text-[.75rem] md:text-[1rem] !important;
    font-weight: 500;
